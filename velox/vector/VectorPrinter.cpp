...
class VectorPrinter {
 public:
  VectorPrinter(const BaseVector& vector) : decoded_{vector} {}
...
class PrimitiveVectorPrinter : public VectorPrinter {
 public:
  PrimitiveVectorPrinter(const BaseVector& vector) : VectorPrinter(vector) {}
...
class ArrayVectorPrinter : public VectorPrinter {
 public:
  ArrayVectorPrinter(const BaseVector& vector) : VectorPrinter(vector) {
...
class MapVectorPrinter : public VectorPrinter {
 public:
  MapVectorPrinter(const BaseVector& vector) : VectorPrinter(vector) {
...
class RowVectorPrinter : public VectorPrinter {
 public:
  RowVectorPrinter(const BaseVector& vector) : VectorPrinter(vector) {
...
void printSizeAndNullCount(const BaseVector& vector, std::ostringstream& out) {
  const auto nullCount = BaseVector::countNulls(vector.nulls(), vector.size());
  out << vector.size() << " elements, " << nullCount << " nulls";
}
