...
WindowNode::BoundType WindowNode::boundTypeFromName(const std::string& name) {
  static const std::unordered_map<std::string, BoundType> kTypes = {
      {"CURRENT ROW", BoundType::kCurrentRow},
      {"PRECEDING", BoundType::kPreceding},
      {"FOLLOWING", BoundType::kFollowing},
      {"UNBOUNDED PRECEDING", BoundType::kUnboundedPreceding},
      {"UNBOUNDED FOLLOWING", BoundType::kUnboundedFollowing},
  };
...
WindowNode::WindowType WindowNode::windowTypeFromName(const std::string& name) {
  static const std::unordered_map<std::string, WindowType> kTypes = {
      {"ROWS", WindowType::kRows},
      {"RANGE", WindowType::kRange},
  };
...
folly::dynamic WindowNode::serialize() const {
  ...
  obj["sortingOrders"] = folly::dynamic::array();
  for (const auto& order : sortingOrders_) {
    obj["sortingOrders"].push_back(order.serialize());
  }
...
PlanNodePtr WindowNode::create(const folly::dynamic& obj, void* context) {
  ...
  auto sortingKeys =
      ISerializable::deserialize<std::vector<FieldAccessTypedExpr>>(
          obj["sortingKeys"], context);

  std::vector<SortOrder> sortingOrders;
  for (const auto& order : obj["sortingOrders"]) {
...
void PlanNode::registerSerDe() {
  ...
  registry.Register("CrossJoinNode", core::CrossJoinNode::create);
  registry.Register("EnforceSingleRowNode", core::EnforceSingleRowNode::create);
  registry.Register("ExchangeNode", core::ExchangeNode::create);
  registry.Register("FilterNode", core::FilterNode::create);
  registry.Register("GroupIdNode", core::GroupIdNode::create);
  registry.Register("HashJoinNode", core::HashJoinNode::create);
  registry.Register("MergeExchangeNode", core::MergeExchangeNode::create);
  registry.Register("MergeJoinNode", core::MergeJoinNode::create);
  registry.Register("LimitNode", core::LimitNode::create);
  registry.Register("LocalMergeNode", core::LocalMergeNode::create);
  registry.Register("LocalPartitionNode", core::LocalPartitionNode::create);
  registry.Register("OrderByNode", core::OrderByNode::create);
  registry.Register(
      "PartitionedOutputNode", core::PartitionedOutputNode::create);
  registry.Register("ProjectNode", core::ProjectNode::create);
  registry.Register("TableScanNode", core::TableScanNode::create);
  registry.Register("TableWriteNode", core::TableWriteNode::create);
  registry.Register("TopNNode", core::TopNNode::create);
  registry.Register("UnnestNode", core::UnnestNode::create);
  registry.Register("ValuesNode", core::ValuesNode::create);
  registry.Register("WindowNode", core::WindowNode::create);
}
